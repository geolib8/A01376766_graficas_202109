...
function main() 
{
    //se dibujan las figuras y sus rotaciones se declaran
    const canvas = document.getElementById("webglcanvas");
    const gl = initWebGL(canvas);
    initViewport(gl, canvas);
    initGL(canvas);
    let escutoide = new Esc().createEscutoide(gl, [-4, 0, -2], [1.0, 1.0, 0.2], mat4, duration);
    let dodecaedro = new Dod().createDodecaedro(gl, [0, 0, -2], [-0.4, 1.0, 0.1], mat4, duration);
    let octaedro = new Oct().createOctaedro(gl, [4 , 0, -2], [0, 1, 0], mat4,duration);
    ...
    update(gl, shaderProgram, [octaedro, escutoide, dodecaedro]);
}
